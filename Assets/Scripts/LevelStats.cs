...
namespace AimTrainer.Utils
{
    ...
    {
        public static int BASIC_SCORE_MAX = 300;
        // Slowest time
        public static int BASIC_TIME_MAX = 10;
        // Fastest time
        public static int BASIC_TIME_MIN = 1;
        public static float BASIC_KPS_MAX = 3;
        ...
        public static int MOVING_SCORE_MAX = 300;
        // Slowest time
        public static int MOVING_TIME_MAX = 10;
        // Fastest time
        public static int MOVING_TIME_MIN = 1;
        public static float MOVING_KPS_MAX = 3;
        ...
        public static int ANTICIPATION_SCORE_MAX = 300;
        // Slowest time
        public static int ANTICIPATION_TIME_MAX = 30;
        // Fastest time
        public static int ANTICIPATION_TIME_MIN = 5;
